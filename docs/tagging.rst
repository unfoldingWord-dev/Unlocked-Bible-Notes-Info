...
- Multiple note insertion (#xxxn:n). (Example: #luk3:1) This tag is a device to apply a note written for one Bible passage to another passage as well. It allows the same note to appear in more than one place. In order to use this feature, insert a tag in the tag list below the source note that points to the other location where you want the note to appear. For example, an note for Luke 3:2 could also appear in Matthew 2:7 if a “#mat2:7” tag was inserted in the list of tags for the Luke 3:2 note. It is possible to connect a note to multiple other notes by inserting multiple, separate tags that point to the desired destination notes.
